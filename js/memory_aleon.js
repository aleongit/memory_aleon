...
const conta_partida = () => {
  let interval = setInterval(function () {
    ...
    conta++;
    document.querySelector("#timer_joc").innerHTML =
      "00:" + (TEMPS_JOC - conta);
  }, 1000);
...
//mirar marcades
const mira_marcades = () =>
  document.querySelectorAll("#taula td[class*='marcada']");
...
//mira destapades ko
const mira_destapades = () =>
  document.querySelectorAll("#taula td[class*='ko']");
